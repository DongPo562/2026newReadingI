...
def get_word_at_cursor():
    ...
    try:
        ...
        # 4. OCR 获取单词和边界框
        # lang='eng' 指定英文，--psm 6 表示假设为单一文本块
        ...
        print(f"[CtrlTrigger] DEBUG: OCR found {n_boxes} text boxes")
        ...
        for i in range(n_boxes):
            ...
            print(f"[CtrlTrigger] DEBUG: Word '{word}' bbox=({x},{y},{w},{h}) -> shrunk=({sx:.1f},{sy:.1f},{sw:.1f},{sh:.1f}) conf={conf}")
